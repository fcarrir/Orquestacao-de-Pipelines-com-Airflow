...
enemnovo = (
    ...
    .load("s3://datalake-fcarrir-learning-930800861540-af/staging-zone/enem")
)
...
enemvelho = DeltaTable.forPath(spark, "s3://datalake-fcarrir-learning-930800861540-af/staging-zone/enem")
